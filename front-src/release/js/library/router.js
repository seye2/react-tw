...
(function(name, definition) {
    ...
    function addLoadListener( el, listener ){
        if (el.addEventListener) {
          el.addEventListener('load', listener, false);
        } else if (el.attachEvent)  {
          el.attachEvent('load', listener);
        }
    }
    ...
    var Router = function(options) {
        ...
        this._hasLoadHandler = this._onHashChange.bind(this);
        addHashchangeListener(window,this._hasChangeHandler);
        addLoadListener(window,this._hasLoadHandler);
    };
    ...
    */
    ...
    Router.prototype.removeHistory = function() {
        this._routes=[];
    }
