...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        buildListItems: function (pages) {
            ...
            if (this.options.prev) {
                ...
                $listItems = $listItems.add(this.buildItem('wrap'));
            }
        ...
        buildItem: function (type, page) {
            ...
            switch (type) {
                case 'page':
                    itemText = page;
                    itemContent.addClass(this.options.pageClass);
                    break;
                case 'first':
                    itemText = this.options.first;
                    itemContent.addClass(this.options.firstClass);
                    break;
                case 'prev':
                    itemText = this.options.prev;
                    itemContent.addClass(this.options.prevClass);
                    break;
                case 'next':
                    itemText = this.options.next;
                    itemContent.addClass(this.options.nextClass);
                    break;
                case 'last':
                    itemText = this.options.last;
                    itemContent.addClass(this.options.lastClass);
                    break;
                case 'wrap':
                    break;
                default:
            ...
            if(type=='wrap') {
                ...
                itemContent.append(itemContent.attr('href', this.makeHref(page)).html(itemText));
            } else {
                itemContent.append(itemContent.attr('href', this.makeHref(page)).html(itemText));
            }
        ...
        render: function (pages) {
            ...
            jQuery('.paging span').append(jQuery('.paging .page-item'));

            var children = this.$listContainer.find('a');
    ...
    $.fn.twbsPagination.defaults = {
        ...
        hrefVariable: '{{number}}',
        first: 'First',
        prev: '<i class="fa fa-chevron-left"></i><span>이전</span>',
        next: '<i class="fa fa-chevron-right"></i><span>다음</span>',
        last: 'Last',
        loop: false,
        onPageClick: null,
