 ...
 * html template
 *********************************************************************************/
var ShopMap = React.createClass({displayName: "ShopMap",
    url:loc[8].api[0],
    type:loc[8].type,
    method:'post',
    prevData:false,
    ...
    render : function () {
        ...
        return (
            React.createElement("div", {className: "page "+loc[8].pageName+" "+this.props.position}, 
                _contentsTab, 
...
var ModalAll = React.createClass({displayName: "ModalAll",
    render: function () {
        ...
        return (
            React.createElement("div", {className: "list-map"}, 
