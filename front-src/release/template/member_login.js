 ...
 * html template
 *********************************************************************************/
var MemberLogin = React.createClass({displayName: "MemberLogin",
    reJoinDate:'',
    dropOutDate:'',
    blockEndDate:'',
    authIdx:'',
    ...
    render : function() {
        var _contents=null;
            _contents = React.createElement(MemberLogin, null);

        return (
            React.createElement("div", {className: "page "+loc[1].pageName+" "+this.props.position}, 
                React.createElement("div", {className: "member-info"}, 
                    ...
                    React.createElement("div", {className: "member-contents error-log"}, 
                        React.createElement("div", {className: "cert"}, 
                            React.createElement("div", {className: "inp-type1"}, React.createElement("input", {type: "tel", pattern: "[0-9]{10}", className: "phone", maxLength: "11", placeholder: "* 휴대폰 번호"})), 
                            React.createElement("a", {href: "javascript:void(0);", className: "btn-modal-cert modal-cert"}, React.createElement("span", null, "인증하기"))
                        ), 

                        React.createElement("div", {className: "inp-type1 phone-check"}, 
                            React.createElement("input", {type: "tel", className: "re-phone", pattern: "[0-9]{10}", maxLength: "11", placeholder: "* 기존 휴대폰 번호 입력"})
                        ), 
                        React.createElement("p", {className: "comment"}, "휴대폰 번호가 변경되지 않은 고객께서는 동일한 번호를 입력해주세요."), 

                        React.createElement("div", {className: "inp-type1"}, 
                            React.createElement("input", {type: "password", className: "password", placeholder: "* 비밀번호 입력(영,숫자 혼합 8~15자리)"})
                        ), 
                        React.createElement("div", {className: "forget-password fix"}, 
                            React.createElement("a", {href: "#/member-search-pass", className: "fl"}, "비밀번호를 잊으셨나요? ", React.createElement("i", {className: "fa fa-unlock-alt"})), 
                            React.createElement("a", {href: "#/member-join", className: "fr"}, "회원가입하기")
                        )
                    )

                ), 
                React.createElement("div", {className: "member-footer"}, 
                    React.createElement("a", {href: "javascript:void(0);", className: "btn-start active"}, React.createElement("span", null, "로그인"))
                )
            )
        )
    }
 ...
 * 가입된 전화번호 없음 모달.
 *********************************************************************************/
var ModalNoMemberInfo = React.createClass({displayName: "ModalNoMemberInfo",
    componentDidMount : function () {
    ...
    render : function () {
        return (
            React.createElement("section", {className: "modal modal-small modal-no-member-info", style: this.props}, 
                React.createElement("div", {className: "modal-inner"}, 
                    React.createElement("div", {className: "modal-header icon-type1"}), 
                    ...
                    React.createElement("div", {className: "modal-content"}, 
                        React.createElement("div", {className: "message"}, 
                            React.createElement("p", {className: "text-type2"}, "010-1234-4322"), 
                            React.createElement("span", {className: "text-type4"}, "가입된 정보가 없습니다.")
                        )
                    ), 
    ...
    render : function(){
        ...
        return (
            React.createElement("div", null, 
                ...
                React.createElement(ModalNoMemberInfo, React.__spread({},  props))
            )
        )
    }
});