 ...
 *
 **************************************************/
var MenuMain = React.createClass({displayName: "MenuMain",
    _memStatus : null,
    ...
    render : function() {
            ...
            _createItem=function(item) {
                return (
                    React.createElement("div", null, 
                        React.createElement("div", {className: "menu-min-coin fix "+item.cls}, 
                            ...
                            React.createElement("div", {className: "menubox"}, 
                                React.createElement("div", {className: "min"}, 
                                    React.createElement("div", {className: "show-number"}, 
                                        ...
                                        React.createElement("strong", {className: "my-min"}, item.my_min)
                                    ), 
                            ...
                            React.createElement("div", {className: "menubox"}, 
                                ...
                                React.createElement("div", {className: "coin"}, 
                                    ...
                                    React.createElement("div", {className: "show-number"}, 
                                        ...
                                        React.createElement("strong", {className: "my-coin"}, item.my_coin)
                                    ), 
                        ...
                        React.createElement("div", {className: "menu-link-box"}, 
                            React.createElement("ul", {className: "fix"}, 
                                React.createElement("li", null, React.createElement("a", {id: "active my-wallet", href: "#/my-wallet"}, "나의월렛")), 
                                React.createElement("li", null, React.createElement("a", {id: "my-coupon", href: "#/my-coupon"}, "나의쿠폰")), 
                                React.createElement("li", null, React.createElement("a", {id: "coupon-exchange", href: "#/coupon-exchange"}, "쿠폰교환")), 
                                React.createElement("li", null, React.createElement("a", {id: "bookmark", href: "#/bookmark"}, "즐겨찾기")), 
                                React.createElement("li", null, React.createElement("a", {id: "used-list", href: "javascript:void(0);"}, "이용내역")), 
                                React.createElement("li", null, React.createElement("a", {id: "coin-donate", href: "javascript:void(0);"}, "기부하기")), 
                                React.createElement("li", null, React.createElement("a", {id: "notice", href: "#/notice"}, "공지사항")), 
                                React.createElement("li", null, React.createElement("a", {id: "setting", href: "javascript:void(0);"}, "환경설정"))
                            )
                        )
                    )
                );
        ...
        return (
            React.createElement("div", {className: "page "+loc[9].pageName+" "+this.props.position}, 
                _contents, 
