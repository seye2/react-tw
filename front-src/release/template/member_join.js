 ...
 * html template
 *********************************************************************************/
var MemberJoin = React.createClass({displayName: "MemberJoin",
    reJoinDate:'',
    dropOutDate:'',
    blockEndDate:'',
    authIdx:'',
    ...
    render: function() {
        ...
        _contents = React.createElement(MemberJoin, null);

        return (
            React.createElement("div", {className: "page "+loc[0].pageName+" "+this.props.position}, 
                React.createElement("div", {className: "member-info"}, 
                    React.createElement("div", {className: "member-title"}, 
                        React.createElement("h3", null, "회원가입정보"), 
                        React.createElement("p", {className: "essential"}, "*표시는 필수 입력사항 입니다.")
                    ), 
                    React.createElement("div", {className: "member-contents error-log"}, 

                        React.createElement("div", {className: "cert"}, 
                            React.createElement("div", {className: "inp-type1"}, React.createElement("input", {type: "tel", pattern: "[0-9]*", inputmode: "numberic", min: "0", className: "phone", maxLength: "11", placeholder: "* 휴대폰 번호"})), 
                        ...
                        React.createElement("div", {className: "inp-type1"}, 
                            React.createElement("input", {type: "password", className: "password", maxLength: "15", placeholder: "* 비밀번호 입력(영,숫자 혼합 8~15자리)"}), 
                            React.createElement("span", {className: "marker good"}), 
                            React.createElement("span", {className: "marker ng"})
                        ), 

                        React.createElement("div", {className: "inp-type1"}, 
                            React.createElement("input", {type: "password", className: "re-password", placeholder: "* 비밀번호 확인"}), 
                            React.createElement("span", {className: "marker good"}), 
                            React.createElement("span", {className: "marker ng"})
                        ), 
                ...
                React.createElement("div", {className: "member-footer"}, 
                    React.createElement("a", {href: "javascript:void(0);", className: "btn-start active"}, React.createElement("span", null, "가입하기"))
                )
            )
        )
    }
                ...
                React.createElement("div", {className: "modal-inner"}, 
                    ...
                    React.createElement("div", {className: "modal-content"}, 
                        ...
                        React.createElement("div", {className: "num-area"}, 
                            React.createElement("input", {type: "tel", maxLength: "5"})
                        ), 
                        React.createElement("div", {className: "time-area"}, 
                            ...
                            React.createElement("p", {className: "lack-length text-type4", style: _hide}, "인증번호 4자리를 다 입력해주세요."), 
                            React.createElement("p", {className: "wrong-typing text-type4", style: _hide}, "5회 이상 틀렸습니다. 인증번호를 새로 받아주세요.")
                        )
                    ), 
 ...
 * 재가입 여부 확인 모달
 *********************************************************************************/
var ModalInHistory = React.createClass({displayName: "ModalInHistory",
    render : function() {
        return (
            React.createElement("section", {className: "modal modal-already-reg", style: this.props}, 
                React.createElement("div", {className: "modal-inner"}, 
                    ...
                    React.createElement("div", {className: "modal-content"}, 
                        React.createElement("div", {className: "message"}, 
                            ...
                            React.createElement("p", {className: "text-type4"}, React.createElement("span", {className: "date"}, "2015. 6. 21"), " 가입내역이 있습니다."), 
                            React.createElement("p", {className: "text-type5"}, "재가입시 기존정보는 모두 삭제됩니다.")
                        )
                    ), 
                    ...
                    React.createElement("div", {className: "modal-footer fix"}, 
                        React.createElement("div", {className: "btnbox"}, 
                            ...
                            React.createElement("a", {className: "btn-type1", href: "javascript:void(0);"}, "재가입")
                        )
                    )
                )
            )
                ...
                React.createElement("div", {className: "modal-inner"}, 
                    ...
                    React.createElement("div", {className: "modal-content"}, 
                        React.createElement("div", {className: "message"}, 
                            ...
                            React.createElement("p", {className: "text-type5"}, "남은 탈퇴 대기시간 ", React.createElement("span", {class: "time"}, " 21:59 "))
                        )
                    ), 
 ...
 *********************************************************************************/
var ModalPhoneCert = React.createClass({displayName: "ModalPhoneCert",
    render : function() {
        return (
            React.createElement("section", {className: "modal modal-small modal-phone-cert", style: this.props}, 
                React.createElement("div", {className: "modal-inner"}, 
                    React.createElement("div", {className: "modal-header icon-type2"}), 

                    React.createElement("div", {className: "modal-content"}, 
                        React.createElement("div", {className: "message"}, 
                            React.createElement("p", {className: "text-type1"}, "휴대폰 인증"), 
                            React.createElement("div", {className: "cert"}, 
                                React.createElement("div", {className: "inp-type1"}
                            ...
                            React.createElement("p", {className: "text-type5 left"}, "휴대폰 인증을 하셔야 재가입 할 수 있습니다.")
                        )
                    ), 
    ...
    render : function(){
        ...
        return (
            React.createElement("div", null, 
                ...
                React.createElement(ModalPhoneCert, React.__spread({},  props)), 
                React.createElement(ModalInHistory, React.__spread({},  props)), 
